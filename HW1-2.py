...
print(a_centered_sp)
a_centered_sp_by_n = a_centered_sp / (a.shape[0]-1)
print(a_centered_sp_by_n)
...
#
top = authors_price.sort_values(by = 'price')
top5 = top.drop(5:, axis = 0)
print(top5)
...
authors_stat = authors_stat.drop('author_id', 'book_title')
print(authors_stat)
